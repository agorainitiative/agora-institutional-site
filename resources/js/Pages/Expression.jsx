    ...
    return (
        <>
            ...
            <div style={{ padding: "100px 200px" }} className="text-black">
                ...
                <br />
                <strong>Proactive Monitoring</strong> Utilizing sophisticated social listening tools, we analyze millions of posts across various platforms to detect emerging trends of disinformation and hate speech. This allows us to respond rapidly before these messages gain traction. Then through the use of advanced analytics and OSINT (Open Source Intelligence) technology, we delve deep into data to understand patterns and identify the sources of misleading campaigns. This rigorous analysis helps us map out the networks that propagate harmful content. 
                <br />
                <strong>Counter-Narratives and exposing the source of maliciouse campaign</strong> We actively develop and promote content that counters misinformation with factual information but people often exhibit confirmation bias, favoring information that reinforces their pre-existing beliefs and ignoring contrary evidence. As a major part of our strategy expose the sources and motives behind organized disinformation and hate speech campaign is crucial. When people discover the sources and intentions behind the information they’ve been exposed to, it can often lead to a feeling that they do not have full control over their own opinions. This realization can be unsettling as it challenges the autonomy they presume to have over their thoughts and beliefs.
                <br />
